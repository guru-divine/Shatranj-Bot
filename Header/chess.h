...
#define TWO_BOTS false				// assuming AGAINST_BOT is true, if true then it's bot vs bot, if false then it's player vs bot
...
#define WHITE_BOT_RANDOM false		// if true the white bot returns random moves, if false the white bot returns smart moves generated by minimax algorithm
